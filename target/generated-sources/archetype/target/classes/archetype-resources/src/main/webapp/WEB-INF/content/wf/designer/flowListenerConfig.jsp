...
jq(function(){
	...
	_line_listener_fields_dg=jq('${symbol_pound}line-listeners-fields-list').datagrid({
		//title:"Listener",
	    ...
	    toolbar:[{
	        ...
	        handler:function(){
				...
				jq('${symbol_pound}line-listeners-fields-list').datagrid('appendRow',{
					id:'',
					fieldName:'',
					type:'',
					value:'',
				...
				var index = jq('${symbol_pound}line-listeners-fields-list').datagrid('getRows').length-1;
				jq('${symbol_pound}line-listeners-fields-list').datagrid('beginEdit', index);
	        }
	    }],
...
<table>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<a href="${symbol_pound}${symbol_pound}" id="fieldCancelBt" onclick="closeLineListenerWin()">Cancel</a>
			</td>
		</tr>
</table>