...
jq(function(){
	...
	_task_listener_fields_dg=jq('${symbol_pound}task-listeners-fields-list').datagrid({
		//title:"Listener",
	    ...
	    toolbar:[{
	        ...
	        handler:function(){
				...
				jq('${symbol_pound}task-listeners-fields-list').datagrid('appendRow',{
					id:'',
					fieldName:'',
					type:'',
					value:'',
				...
				var index = jq('${symbol_pound}task-listeners-fields-list').datagrid('getRows').length-1;
				jq('${symbol_pound}task-listeners-fields-list').datagrid('beginEdit', index);
	        }
	    }],
	...
	jq("${symbol_pound}listenerServiceClass").autocomplete(_process_def_provided_listeners, {
		width: 450,
		minChars: 0,
		max: 10,
		autoFill: true,
...
<table>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<a href="${symbol_pound}${symbol_pound}" id="fieldCancelBt" onclick="closeTaskListenerWin()">Cancel</a>
			</td>
		</tr>
</table>