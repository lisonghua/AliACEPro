...
<div id="assignPrivilege">
    <div title="<s:text name='label.pm.module.assign.user'></s:text>"  selected="true" style="overflow:hidden;padding:5px;" href="${ctx}/pm/module/module!forAssignUser.action?moduleId=${moduleId}">
<!--		<iframe src="${ctx}/pm/module/module!forAssignUser.action?moduleId=${moduleId}" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no"></iframe>-->
    ...
    <div title="<s:text name='label.pm.module.assign.role'></s:text>"  style="overflow:hidden;padding:5px;" href="${ctx}/pm/module/module!forAssignRole.action?moduleId=${moduleId}">
