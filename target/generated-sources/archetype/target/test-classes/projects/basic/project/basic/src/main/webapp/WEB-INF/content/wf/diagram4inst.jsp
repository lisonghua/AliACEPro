...
<head>
		...
		<link href="${ctx}/js/jQueryBubblePopup/jquery.bubblepopup.v2.3.1.css" type="text/css" rel="stylesheet"/>
		<script src="${ctx}/js/jQueryBubblePopup/jquery.bubblepopup.v2.3.1.min.js" type="text/javascript"></script>	
			...
			jqTask.mouseover(function(event){
			    ...
			    jq(this).ShowBubblePopup({
					innerHtml: "<ul><li><s:text name='lable.wf.process.diagram.process'></s:text>:"+processName
						...
						+"</li></ul>",		
					innerHtmlStyle: { color:'#333333', 'text-align':'left','font-size':'14px' },							
					themeName: 	'azure',
					themePath: 	'${ctx}/js/jQueryBubblePopup/jquerybubblepopup-theme',
					selectable:true,
					openingSpeed:0,
					closingSpeed:0								 
			  });
				  /*
			    var _wf_acti_info = jq('#task-tip-'+taskId);
