...
function save(){
	_editor_form_obj.ajaxSubmit({
			url:"${ctx}/sm/server/server!save.action",
			type: 'POST',
			dataType:'json',
	...
	<input type="hidden" name="serverId" value="${serverId}"/>
		<table>
			...
			<tr>
				...
				<td><input type="text" id="port" name="port" value="${port}" size="50"></input></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="version" name="version" value="${version}" size="50"></input></td>
			</tr>
			<tr>
