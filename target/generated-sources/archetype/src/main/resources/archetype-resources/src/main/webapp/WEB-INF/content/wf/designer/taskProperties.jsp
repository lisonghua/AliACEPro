	...
	jq('${symbol_pound}task-listeners-list').datagrid({
	    ...
	    toolbar:[{
	        ...
	        handler:function(){
	    		...
	    		//_listener_frame.src="";
	    		_listener_win.window('refresh','${symbol_dollar}{ctx}/wf/procdef/procdef!forTaskListenerConfig.action');
...
function switchTaskCandidatesList(performerType){
	if(performerType == 'candidateUsers'){
		task_candidate_panel.panel("refresh","${symbol_dollar}{ctx}/wf/procdef/procdef!forTaskCandidateUsersConfig.action");
	}else if(performerType == 'candidateGroups'){
		task_candidate_panel.panel("refresh","${symbol_dollar}{ctx}/wf/procdef/procdef!forTaskCandidateGroupsConfig.action");
	}
}
...
function editListener(id){
	_listener_win.window('open');
	_listener_win.window('refresh','${symbol_dollar}{ctx}/wf/procdef/procdef!forTaskListenerConfig.action?listenerId='+id);
}
...
function formActionBt(value,rowData,rowIndex){
    ...
    var d = '<img onclick="deleteForm('+id+')" src="${symbol_dollar}{ctx}/image/delete.gif" title="'+"<s:text name='button.common.delete'></s:text>"+'" style="cursor:hand;"/>';
	return e+'&nbsp;'+d;
}
...
function populateTaskProperites(){
	...
	jq('${symbol_pound}performerType').combobox('setValue',task.performerType);
